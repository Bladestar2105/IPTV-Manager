...
| POST | `/api/ai/codex/session/end` | End unfinished account-link attempts belonging to this bearer session before Web UI logout. Idempotent and available without AI-policy access; completed links and other sessions are unchanged. |
