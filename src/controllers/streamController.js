...
export const proxySegment = async (req, res) => {
  try {
    ...
    // Only run SSRF check for raw URL params (not for server-generated base64 payloads)
    // When data param is present, the URL was generated by our own m3u8 rewriter
    // and was already validated when the original stream was proxied
    if (!req.query.data) {
