...
const MANIFEST_BODY_TIMEOUT_MS = Number(process.env.MANIFEST_BODY_TIMEOUT_MS) || 30000;
const MANIFEST_MAX_BYTES = Number(process.env.MANIFEST_MAX_BYTES) || 32 * 1024 * 1024;
